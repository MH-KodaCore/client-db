  ...
  return (
    <div className="border rounded-md w-full sm:w-2/5 mx-auto p-4 space-y-4 border-[#2C8F13] mt-3">
      {[
        ...
        >
          ...
          <input
            ...
            className="w-full sm:flex-1 p-2 rounded border border-[#637160]"
          />
        </div>
      ))}
      ...
      <div className="flex items-center justify-center gap-2">
        <input
          type="checkbox"
          className="appearance-none w-5 h-5 border-2 border-[#303030] rounded-sm checked:bg-[#135E00] checked:border-transparent cursor-pointer"
        />
